...
public class GenderBitmapCreation {
    public static String createUncompressedAndCompressedIndex(String genderIndexFileName, int fileNumber)
            throws IOException {
        System.out.println("\n====================== Creating Gender BitMap Index & Compressed Index For File Number: "
                + fileNumber + " ====================\n");
        ...
        FileWriter fw = new FileWriter(
                Configuration.FILE_PATH + genderIndexFileName + fileNumber + Configuration.FILE_EXTENSION);
        ...
        writes++;
        CompressedBitMap.readBitSetToCreateCompressedBitSetAndWriteToFile("0", bitset,
                Configuration.GENDER_COMPRESSED_BITMAP_FILE_NAME + fileNumber + Configuration.FILE_EXTENSION);
        fr.close();
        ...
        // +1 write to write compressed bitmap
        writes++;
        CompressedBitMap.readBitSetToCreateCompressedBitSetAndWriteToFile("1", bitset,
                Configuration.GENDER_COMPRESSED_BITMAP_FILE_NAME + fileNumber + Configuration.FILE_EXTENSION);
        fr.close();
        fw.flush();
        fw.close();
        ...
        System.out.println("Total Disk I/O's for Creating Gender BitMap=" + (reads + writes));
